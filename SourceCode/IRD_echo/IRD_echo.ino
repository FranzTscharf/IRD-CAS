...
//==================================INITIATE======================================//
#define PING_PIN_1 2 // front
#define PING_PIN_2 3 // right
#define PING_PIN_3 4 // left
#define PING_PIN_4 5 // left-front 45°
#define PING_PIN_5 6 // right-front 45°
#define PING_PIN_6 7 // top-front
...
void MedirSensores() {
  ...
  Sensor[5].Distances[0] = sonar5.ping_cm();
}
...
void MediaDistances() {
  ...
  /*Serial.print("\n\rDistances: ");
    ...
    //TODO Serial.print(",");
    //TODO Serial.print(Sensor[5].MediaDistances);
    Serial.print("cm\n\r");*/
}
